...
##testing modules
import signin, ago_cursor, timing, utils.sync_operations as sync_operations, return_ago_edits, return_df_ago_test, backup, getToken
from post_sync import checkSync
    ...
    try:
        ...
        if editedTables is not None:
            ...
            for k,v in editedTables.items():
                ...
                insert = sync_operations.returnInserted(k, cursor, ago, whereClause)
                update = sync_operations.returnUpdated(k, cursor, ago, whereClause)
                delete = sync_operations.returnDeleted(k, cursor, ago, whereClause)
                ...
                success = checkSync(source, destination)
